        ...
        {activePopover === "color" && (
          <div data-no-drag className="absolute top-full right-0 mt-3 w-64 bg-[#1D1D1D] border border-white/10 rounded-[12px] p-4 shadow-xl animate-in fade-in slide-in-from-top-2 z-50 flex flex-col gap-4" onTouchStart={(e) => e.stopPropagation()}>
            ...
            <div className="flex items-center gap-3">
              <button
    // onClick ki jagah onPointerDown use karein taake Safari block na kare
    onPointerDown={async (e) => {
        ...
        if ("EyeDropper" in window) {
            try {
                ...
                setActivePopover(null); // Close it after success
            } catch (e) {
            ...
            // Fallback for Mobile (Safari iPadOS): Switch to Canvas Picker mode
            dispatch(setCurrentBrush({ mode: "picker" }));

...
const Toolbox = ({ boundaryRef }: any) => {
  ...
  // Popover States
  const [activePopover, setActivePopover] = useState<"brush" | "color" | null>(
    null,
  );
  ...
  const toggleBrushPopover = () =>
    setActivePopover(activePopover === "brush" ? null : "brush");
  ...
  return (
    ...
    >
      {/* Drag Handle (Dots) */}
      <div className="cursor-grab active:cursor-grabbing px-2 text-white hover:text-white/70 transition-colors">
        <List />
      </div>
      ...
      <div className="relative">
        <button
          ...
          className={`w-10 h-10 rounded-[6px] flex items-center justify-center transition-all shadow-md ${
            activePopover === "color"
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="h-4 rounded-full flex-1 relative overflow-hidden">
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(to right, #FF9797, #8288FF, #FFE26C, #92FF57, #4DC9A1, #729BA6, #FF4242)",
                  }}
                />
                <div

        ...
        <div className="bg-[#1A1A1A] rounded-[8.03px] border border-white/10 overflow-hidden flex flex-col p-2.5 bg-[#2E2E2E]">
            ...
            <div className="py-3  flex flex-col gap-2  ">
                ...
                <div className="flex items-center justify-between">
                    <h3 className="!text-white text-sm lg:text-lg font-semibold">{title}</h3>
                    <div className="flex items-center gap-2">
                        ...
                        <button className="w-8 h-8 rounded-lg bg-[#BE0000] flex items-center justify-center !text-white hover:bg-red-500/30 transition-colors">
                ...
                <div className="flex items-center justify-center gap-8">
                    <div className="text-center">
                        ...
                        <p className="!text-white lg:text-lg font-semibold">{contributors}</p>
                    </div>
                    <div className="text-center">
                        <p className="!text-[#AAB2C7] text-xs mb-1">Pixel Painted</p>
                        <p className="!text-white lg:text-lg font-semibold">{pixelsPainted.toLocaleString()}</p>
                    </div>
                </div>

                {/* Buttons */}
                <div className="flex flex-col gap-2 mt-2">
                    <button className="w-full py-3 rounded-full bg-gradient-to-r from-[#E23373] to-[#FEC133] !text-white font-semibold text-[10px] hover:opacity-90 transition-opacity">
                        View Artwork
                    </button>
                    <div className="w-full p-[1px] rounded-full bg-gradient-to-r from-[#E23373] to-[#FEC133]">
                        <button className="w-full py-3 rounded-full bg-[#1A1A1A] !text-white font-semibold text-[10px] hover:opacity-80 transition-opacity">
                            Mark as Done
                        </button>
                    </div>
                </div>
...
const FeaturedArtwork: React.FC<FeaturedArtworkProps> = ({ imageSrc, artistType, title, description }) => {
    return (
        <div className="flex flex-col gap-4 ">
            ...
            <div className="space-y-2">
                <span className="!text-[#AAB2C7] text-sm font-medium lg:text-base">{artistType}</span>
                <h3 className="!text-white text-[36px] font-semibold">{title}</h3>
                <p className="!text-white text-sm lg:text-base font-semibold leading-relaxed">{description}</p>
            </div>
        </div>
    );
};
...
const ActiveProjectsSection: React.FC = () => {
    const projects = [
        {
            imageSrc: "https://images.unsplash.com/photo-1578301978693-85fa9c0320b9?q=80&w=2044&auto=format&fit=crop",
            title: "Building Test",
            progress: 15,
            contributors: 4,
            pixelsPainted: 11014
        ...
        {
            imageSrc: "https://images.unsplash.com/photo-1518709268805-4e9042af9f23?q=80&w=1984&auto=format&fit=crop",
            title: "Building Test",
            progress: 15,
            contributors: 4,
            pixelsPainted: 11014
    ...
    const featuredArtwork = {
        ...
        title: "Artistic Gem",
        description: "Unleash precise strokes and effortless control—an artistic gem designed for digital sketchers who demand clarity, detail, and elegance in every line."
    };
                ...
                <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <div className="flex-1">
                        ...
                        <div className="flex justify-between items-start mb-5 ">
                            ...
                            {/* Button with Border */}
                            <button className="px-8 py-2.5 rounded-full border border-white/30 !text-white text-sm font-medium hover:bg-white/5 transition-colors">
                                Projects
                            </button>
                        </div>

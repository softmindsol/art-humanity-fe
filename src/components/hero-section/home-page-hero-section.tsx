    ...
    <div className="w-full xl:max-h-[808px] lg:max-h-[758px] md:max-h-[650px] h-[510px] md:h-[650px] lg:h-[758px] xl:h-[808px] relative flex items-start lg:items-center bg-[#030303]">
      ...
      <div className="max-w-[1440px] md:px-10 px-8 mx-auto my-auto relative z-10 w-full">
        ...
        <div className="w-full md:w-1/2 flex flex-col items-start xl:space-y-8 lg:space-y-6 space-y-4">
          ...
          <h1 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl !text-white font-bold text-white leading-[1.1] lg:leading-[1.1] ">
          ...
          <p className="!text-white !font-medium text-sm lg:text-base xl:text-lg max-w-xl leading-relaxed drop-shadow-md">
          ...
          <Link to="/gallery">
            <div className="relative p-[1px] rounded-full bg-gradient-to-r from-[#E23373] to-[#FEC133] group hover:opacity-90 transition-opacity">
              <Button className="rounded-full px-[17px] py-[7px] bg-black text-white hover:bg-black/90 transition-all duration-300 flex items-center gap-2 text-base font-semibold border-none relative z-10">
                Explore Now

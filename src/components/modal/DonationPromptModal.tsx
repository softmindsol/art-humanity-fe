...
const CustomModal: React.FC<CustomModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/80 flex justify-center items-center z-50 backdrop-blur-sm p-4">
      <div className="w-full max-w-[535px] p-[1px] rounded-[12px] top-10 bg-gradient-to-br from-[#545454] to-[#212121] shadow-2xl relative">
        <div className="bg-[#0f0f0f] w-full h-full rounded-[14px] p-6 sm:p-8">
          ...
          <h2 className="sm:text-[22px] text-[18px] font-bold !text-white text-center">
            Support the Collaborative Art
          </h2>

          <p className="mt-4 sm:text-[16px] text-[13px] !text-white text-center leading-relaxed">
            Our Platform is a community-driven space for creativity. Your
            donation helps us maintain the servers, develop new features, and
            keep the art alive
          </p>

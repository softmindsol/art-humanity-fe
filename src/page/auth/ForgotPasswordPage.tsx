                    ...
                    {!submitted ? (
                        <>
                            <div className="space-y-2">
                                <h3 className="!text-white text-[20px] lg:text-[26px] font-semibold">Reset Password</h3>
                                ...
                                <p className="text-white font-semibold text-[14px] lg:text-lg">
                                    We'll send you an Email verification code to reset the password of your account
                                </p>
                            </div>

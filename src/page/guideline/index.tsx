...
const GuidelinePage: React.FC = () => {
  return (
    <div className="min-h-screen bg-[#0F0D0D] text-gray-200 font-montserrat">
      {/* Hero Section */}
      <section className="w-full xl:max-h-[808px] lg:max-h-[758px] md:max-h-[650px] h-[510px] md:h-[650px] lg:h-[758px] xl:h-[808px] relative flex items-start lg:items-center bg-[#030303]">
      ...
      >
        <div className="max-w-[1440px] mx-auto px-6 lg:px-8 ">
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-24">
            ...
            <div className="relative w-full lg:w-1/2 flex items-center justify-center">
              <div className="grid grid-cols-3 gap-2 sm:gap-4 items-center w-full max-w-[600px]">
                ...
                <div className="h-[250px] sm:h-[340px] md:h-[416px] w-full rounded-[12px] overflow-hidden shadow-2xl z-10">
                  <img
                    src="/assets/guideline-art-3.svg"
                    className="w-full h-full object-cover hover:scale-110 transition-transform duration-500"
                    alt="Art 2"
                  />
                </div>
            ...
            {/* Right Text Section */}
            <div className="relative w-full lg:w-1/2 md:space-y-6 space-y-3">
              ...
              <p className=" !text-white leading-relaxed text-sm md:text-base text-left md:text-left">
                Make a contribution in the contributions page and start
                painting. Each pixel you paint will become yours and cannot be
                changed by other contributors. All painted pixels will be
                automatically saved to the currently selected contribution. Each
                user is allowed 10 contributions per project and can be as big
                or as small as you want. If you want to paint on a different
                section of the canvas, create a new contribution and have it
                selected as you paint. All other contributors can upvote your
                contribution to permanently keep it in the canvas or downvote it
                to be deleted from the canvas. If a contribution receives over
                50% downvotes from all project contributors, it will be rejected
                and deleted from the canvas. The project is only complete when
                almost all pixels are painted and not a single contribution
                receives over 50% downvotes.
              </p>

              <div className="absolute 2xl:-right-[11.3%] xl:-right-[5%] lg:-right-8 md:-right-6 -right-6 top-0">
          ...
          <div className="max-w-[1440px] mx-auto px-6 lg:px-8">
            <div className="flex flex-col lg:flex-row gap-16 items-center">
              ...
              <div className="w-full lg:w-1/2 lg:space-y-8 space-y-4">
                <div className="inline-block p-[1px] rounded-full bg-gradient-to-r from-[#E13372] to-[#FEC133]">
                  <div className="px-6 py-2 rounded-full bg-[#0F0D0D] text-white tracking-widest text-xs lg:text-base font-semibold uppercase">
                ...
                <div className="space-y-1 text-left font-medium">
                  <p className="!text-white text-sm md:text-base leading">
                    ...
                    Contributions Live And At Any Point Can Immediately Reject
                    Your Contribution From The Canvas If Your Contribution
                    Clearly And Obviously Doesn't Follow The Rules. If A
                    Moderator Rejects 1 Of Your Contributions, You Will
                    Automatically Be Removed From The Project And Will Not Be
                    Able To Paint Again In The Project.
                  </p>
                  <p className="!text-white text-sm md:text-base leading-[20px]">
                    When Zooming In To Draw, Your Contribution Should Maintain
                    An Isometric-Like Perspective So The Canvas Is Consistent As
                    Seen When Fully Zoomed Out. This Approach Ensures Other
                    Contributions Can Integrate Smoothly With Each Other,
                    Resulting In A Cohesive And Consistent Final Piece.
                  </p>
                  <p className="!text-white text-sm md:text-base leading-[20px]">
                    We Have Three Fundamental Rules That All Contributions Must
                    Follow And Should Be Taken Into Account When Voting For
                    Other Contributions:
                  </p>
                </div>
              </div>
      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-8 py-10 lg:py-20">
        <div className="flex flex-col-reverse lg:flex-row gap-8 lg:gap-16 items-center">
          ...
          <div className="w-full lg:w-2/3 space-y-8">
            <div className="inline-block p-[1px] rounded-full bg-gradient-to-r from-[#E13372] to-[#FEC133]">
              <div className="px-6 py-2 rounded-full bg-[#0F0D0D] text-white tracking-widest text-xs lg:text-sm font-semibold uppercase">
            ...
            <p className="!text-white text-sm sm:text-base 2xl:text-lg leading-relaxed text-left">
              ...
              contribution. Take your time, even if it means painting one small
              detail, and solidify your spot in the canvas. With all of these
              systems in place, you still might encounter trolls interfering
              with your contribution. And you still might have to wait until it
              gets rejected to continue your contribution. The process will be
              long and vigorous but eventually, pixel by pixel, the canvas will
              become one breathtaking, cohesive, final piece of art.
            </p>

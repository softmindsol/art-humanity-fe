...
const PasswordSection = () => {
    ...
    return (
        <div className="bg-[#141414] rounded-2xl p-6 md:p-10 border border-white/5 shadow-2xl mt-8">
            <h3 className="text-lg font-semibold !text-white mb-6">Password</h3>
            
            <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2 md:col-span-2">
                    <Label className="text-base font-semibold !text-white">Current Password</Label>
                ...
                <div className="space-y-2">
                    <Label className="text-base font-semibold !text-white">New Password</Label>
                    <div className="relative">
                        <Input 
                ...
                <div className="space-y-2">
                    <Label className="text-base font-semibold !text-white">Confirm Password</Label>
                    <div className="relative">
                        <Input 
            ...
            <div className="mt-8 flex justify-end">
                ...
                >
                    {passwordLoader ? <Loader2 className="animate-spin w-4 h-4 mr-2" /> : null}
                    Save Changes
                </Button>
            </div>
        </div>

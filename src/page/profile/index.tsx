...
import { getUserById, updateUser, requestEmailChange } from "@/redux/action/auth";
...
const ProfilePage = () => {
    ...
    const handleEmailUpdateConfirm = async () => {
         ...
         try {
             await dispatch(requestEmailChange({
                 userId, 
    ...
    return (
        <div className="min-h-screen bg-[#0F0D0D] text-white font-montserrat pb-20 pt-10 mt-24">
            <div className="container mx-auto px-4 md:px-6 max-w-5xl">
                
                {/* Header */}
                <div className="text-center mb-12">
                    <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-[#E23373] to-[#FEC133] !bg-clip-text !text-transparent inline-block">
                        Your Profile
                    </h1>
                </div>
                ...
                <div className="bg-[#141414] rounded-2xl p-6 md:p-10 border border-white/5 shadow-2xl">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-8 mb-12">
                        <div className="relative group">
                            <div className="w-24 h-24 md:w-28 md:h-28 rounded-full p-[2px] bg-gradient-to-r from-[#E23373] to-[#FEC133]">
                            ...
                            <button 
                                ...
                                className="absolute bottom-0 right-0 p-2 bg-gradient-to-r from-[#E23373] to-[#FEC133] rounded-full text-white hover:scale-110 transition-transform shadow-lg"
                            >
                                <Camera size={16} />
                            </button>
                            <input 
                        ...
                        <div className="flex-1 text-center md:text-left space-y-1">
                            <h2 className="text-lg font-semibold !text-white">{formData.fullName || "User Name"}</h2>
                            <p className="text-[#ffffff]">{profile?.email || "user@example.com"}</p>
                        </div>
                        ...
                        {formData.profileImage && (
                             ...
                             variant="outline" 
                             className="rounded-full border border-[#E23373] font-semibold text-[#E23373] hover:bg-[#E23373]/10 hover:text-[#E23373] px-6"
                         >
                             Remove Photo
                         </Button>
                        )}
                    ...
                    <div>
                        ...
                        <div className="space-y-6">
                            <div className="space-y-2">
                                <Label className="text-base font-semibold !text-white">Name</Label>
                                <Input 
                                    name="fullName"
                        ...
                        <div className="mt-8 flex justify-end">
                            ...
                            >
                                {profileLoader ? <Loader2 className="animate-spin w-4 h-4 mr-2" /> : null}
                                Save Changes
                            </Button>
                        </div>
                    </div>
            ...
            {/* Email Verification Modal */}
             <Dialog open={showEmailVerificationModal} onOpenChange={setShowEmailVerificationModal}>
                <DialogContent className="bg-[#141414] border border-white/10 text-white">
                    <DialogHeader>
                        <DialogTitle className="text-xl font-semibold">Verify Email Change</DialogTitle>
                        <DialogDescription className="text-gray-400">
                            To update your email to <b>{formData.email}</b>, please enter your current password.
                        </DialogDescription>
                    </DialogHeader>
                    ...
                    <DialogFooter>
                        ...
                        >
                            {emailLoader ? <Loader2 className="animate-spin w-4 h-4" /> : "Verify & Update"}
                        </Button>
                    </DialogFooter>
                </DialogContent>
            </Dialog>
